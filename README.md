...
A slide-out Navigation Drawer allows you to switch between 6 distinct modes:
...
*   **Statistics**: Computes sample size, mean, deviance (variance), standard deviation, Z-scores, T-scores, and sample t-statistics in real-time.
